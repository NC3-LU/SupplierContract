...
-- DE
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('REC001_RH', 'Vor der Einstellung eines externen Mitarbeiters wird ein Screening durchgeführt. Bei Beendigung des Arbeitsverhältnisses stellt ein Verfahren sicher, dass dieser Mitarbeiter alle von der Kundenorganisation ausgeliehenen Güter (Geräte, Laptop, Schlüssel, Badges, Smartphone usw.) zurückgibt.', 'de', 'R');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('REC005_AUTHFCT', 'Bei der Wiederverwendung oder Entsorgung von Geräten werden die Kundendaten und die lizensierte Software gelöscht oder deren Datenträger irreversibel zerstört. Der entsprechende Vorgang wird dokumentiert.', 'de', 'R');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('REC009_LOGDEV', 'Der Vertrag berücksichtigt Besonderheiten, die im Zusammenhang mit Software-Entwicklungen stehen, wie z.B. die Lizenzen.  Der Vertrag definiert weiterhin ein Verzeichnis bewährter Praktiken (z.B. OWASP), das bei der Entwicklung zu befolgen ist.', 'de', 'R');
