...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('REC022_VULNRESP', 'The Provider provides timely and appropriate treatment for known vulnerabilities that may impact the Client''s activities.', 'en', 'R');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('REC025_NDA', 'The Service Provider and any subcontractors or cascading suppliers shall respect the confidentiality of the information of which they become aware during the execution of the contract. To this end, a confidentiality and non-disclosure agreement shall be drawn up between the contractual parties. This agreement is binding on the companies and suppliers providing the service as well as their respective employees individually. The commitment may exceed the duration of the execution of the contract if required by the level of confidentiality.', 'en', 'R');
